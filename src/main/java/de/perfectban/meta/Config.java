...
public class Config
{
    ...
    public static final String COMMAND_CHECK_COMMAND = "check.command";
    public static final String COMMAND_CHECK_PERMISSION = "check.permission";
    public static final String COMMAND_CHECK_DESCRIPTION = "check.description";
